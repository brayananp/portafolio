...
export const ui = {
	es: {
		...
		"projects.subtitle":
			"Productos y aplicaciones que he construido. Cada tarjeta abre el detalle completo del proyecto.",
	...
	en: {
		...
		"projects.subtitle":
			"Products and applications I have built. Each card opens the full project detail.",
